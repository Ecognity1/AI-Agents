---
name: prompt-prd-template
description: Reusable PRD template. Use when Codex creates or validates a concise Product Requirements Document.
---
...
List all functionality included.
...
| Epic ID | Epic | Business Goal |

---

# 19. Features

| Feature ID | Epic | Feature | Priority |
...
Identify features included in the first release.
