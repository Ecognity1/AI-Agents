---
name: prompt-prd-template-v1
description: Reusable detailed PRD template. Use when Codex creates or validates a comprehensive Product Requirements Document.
---
