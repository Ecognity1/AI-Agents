---
name: prompt-architecture-template-v1
description: Reusable detailed architecture document template. Use when Codex creates or validates a comprehensive Architecture Design Document.
---
